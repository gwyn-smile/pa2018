...
make_group(gp1,
    ...
    EX(and), EX(sub), EMPTY, IDEX(SI2E, cmp))
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x0c */	IDEXW(I2a, or, 1), EMPTY, EMPTY, EX(2byte_esc),
  ...
  /* 0x70 */	IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1),
  /* 0x74 */	IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1),
  /* 0x78 */	IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1),
  /* 0x7c */	IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1), IDEXW(SI, jcc, 1),
  ...
  /* 0xc4 */	EX(ret), EMPTY, IDEXW(mov_I2E, mov, 1), IDEX(mov_I2E, mov),
  ...
  /* 0xec */	IDEXW(in_dx2a, in, 1), EMPTY, EMPTY, EMPTY,
